...
class FPDF
{
	...
	function SetAuthor($author, $isUTF8 = false)
	{
		...
		$this->metadata['Author'] = $isUTF8 ?
			$author :
			mb_convert_encoding($author, 'UTF-8');
		// utf8_encode($author);
	}
	...
	function SetKeywords($keywords, $isUTF8 = false)
	{
		...
		$this->metadata['Keywords'] = $isUTF8 ?
			$keywords :
			mb_convert_encoding($keywords, 'UTF-8');
	...
	function SetCreator($creator, $isUTF8 = false)
	{
		...
		$this->metadata['Creator'] = $isUTF8 ?
			$creator :
			mb_convert_encoding($creator, 'UTF-8');
		// utf8_encode($creator);
	}
	...
	protected function _httpencode($param, $value, $isUTF8)
	{
		...
		if ($this->_isascii($value))
			return $param . '="' . $value . '"';
		if (!$isUTF8)
			$value = mb_convert_encoding($value, 'UTF-8'); // utf8_encode($value);
